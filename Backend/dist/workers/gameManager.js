...
const newGameQueue = new bull_1.default("refreshCache", "redis://127.0.0.1:6379");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (data.newGame.status) {
                ...
                yield (0, utils_1.cache)(key, [], 30, helpers_1.getCurrentGameParam, client);
            }
        }
        catch (error) {
...
exports.restartGame = new cron_1.CronJob("*/30 * * * *", function () {
